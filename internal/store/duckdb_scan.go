...
func scanReview(r map[string]any) Review {
	review := Review{
		...
		CacheWriteTokens: getInt(r, "cache_write_tokens"),
		CacheReadTokens:  getInt(r, "cache_read_tokens"),
		ReasoningTokens:  getInt(r, "reasoning_tokens"),
		UsageRaw:         getString(r, "usage_raw"),
	}
